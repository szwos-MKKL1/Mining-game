...
namespace Terrain.Blocks
{
    public class BlockRegistry
    {
        ...
        public static readonly BlockBase DUNGEONHALLWAY = new RockBlock((TileBase)AssetDatabase.LoadAssetAtPath("Assets/Sprites/Tiles/piiiXL texture pack/Textures-16_0 1.asset", typeof(TileBase)));
